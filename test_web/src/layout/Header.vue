<template>
    <nav class="nav-bar">
        <div class="nav-logo">
            ...
            <router-link to="/"><span class="nav-name">Coding_Weba</span></router-link>
        </div>
...
li:hover{border-radius: 3px; box-shadow: 0px 0px 10px #fff;}
...
@media screen and (max-width:768px){
    ...
    .active-icons{display:flex; justify-content: center; width: 100%; transition: 0.7s;}
}
</style>